        ...
        <section id="header" class="header main_container">
            <div class="row logo_container">
                <div class="col-md-4">
                    <div class="site_logo">
                        <router-link to="/">
                            <img :alt="siteInfo.siteName" src="//codecloud.cdn.speedyrails.net/sites/5d03c99d6e6f647949080000/image/jpeg/1531764505000/foxrunlogo-white-02.jpg">
                        </router-link>
                    </div>
        ...
        return Vue.component("header-component", {
            ...
            data: function () {
                return {
                    ...
                    windowWidth: 0,
                    siteInfo: site,
                    staticInsta: "//codecloud.cdn.speedyrails.net/sites/5d03c99d6e6f647949080000/image/png/1531763590000/insta-1.png",
                    hoverInsta: "//codecloud.cdn.speedyrails.net/sites/5d03c99d6e6f647949080000/image/png/1531763585000/insta-hover.png"
                }
            },
            ...
            methods: {
                ...
                static() {
                    this.hoverInsta = this.staticInsta;  
                },
                hover() {
                    this.staticInsta = this.hoverInsta;    
                }
            },
