                ...
                <div class="main_container margin_30">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                            <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5d9d6c136e6f647b88020000/image/jpeg/1530645302000/side_banner3.jpg" alt="" />    
                        </div>
            ...
            methods: {
                loadData: async function () {
                    try {
                        ...
                        let results = await Promise.all([this.$store.dispatch("getData", "repos"), this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/foxrun-contact-us.json"})]);
                        return results;
                    } catch (e) {
