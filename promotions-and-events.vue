                ...
                <div class="main_container mobile_padding margin_30">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                            <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5b2960236e6f647f54020000/image/jpeg/1530645302000/side_banner2.jpg" alt="" />    
                        </div>
            ...
            computed: {
                    ...
                    _.forEach(events, function (value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2960236e6f647f54020000/image/jpeg/1527795749000/PlaceHolder4.jpg";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2960236e6f647f54020000/image/jpeg/1527795749000/PlaceHolder4.jpg";
                            }
                ...
                promoList: function promos() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2960236e6f647f54020000/image/jpeg/1527795749000/PlaceHolder2.jpg";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2960236e6f647f54020000/image/jpeg/1527795749000/PlaceHolder2.jpg";
                            }
