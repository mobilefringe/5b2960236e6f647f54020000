                ...
                <div class="main_container margin_30">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                            <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5b2960236e6f647f54020000/image/jpeg/1527708236000/Casas Adobes - 58.jpg" alt="" />    
                        </div>
                ...
                currentPromo : function (){
                    if(this.currentPromo != null) {
                        if (this.currentPromo.promotionable_type === "Store"){
                            ...
                            if  (_.includes(this.currentPromo.promo_image_url_abs, 'missing')) {
                                this.currentPromo.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2960236e6f647f54020000/image/jpeg/1527800297000/PlaceHolder2.jpg";    
                            }
                        }
                    }
                }
